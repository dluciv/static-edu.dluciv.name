...
### Примерные вопросы к экзамену, весна 2026
...
17.  Логические схемы: АЛУ, схемы сдвига, полностью про сумматоры.

Часть II

1.  Логические схемы: арифметика, от вычитания до деления.
2.  Триггеры: RS, D, MS
3.  Триггеры: JK, T.
4.  Регистры: конструкция и назначение сдвигающего регистра, счетчики.
5.  Регистры: чтение и запись, передача данных.
5.  Виды энергонезависимой памяти. Эволюция.
7.  Специфика твердотельных накопителей в сравнении с механическими
    жёсткими дисками.
8.  Защита энергонезависимой памяти. Технология RAID. Использование для
    ускорения операций и обеспечения надежности.
9.  Системы хранения данных. Основные задачи и типы организации (DAS,
    NAS, SAN).
10. Организация RAID-6, математические принципы, способы осуществления
    записи.
11. Вычислительный конвейер; конфликты; пузырьки и торможение конвейера;
    особенности для CISC и RISC.
12. Суперскалярные процессоры и процессоры с внеочередным исполнением
    инструкций.
13. Регистровый файл и система команд Intel x86.
14. Регистровый файл, система команд и формат машинного кода RISC-V.
15. Простейшие цифрово-аналоговые и аналогово-цифровые преобразователи.
16. Применение кодов Грея, последовательностей де Брёйна, кибернетических регуляторов.
17. Вдумчивые и конструктивные предложения и замечания по программе
    курса.

### Критерии оценивания

*... для 2026, а дальше всё может быть иначе!*
...
* онлайн-курса (ниже) — $C \in [0, 1] = [0\\%, 100\\%]$ — загружайте сюда:
  * [ПИ](https://hwproj.ru/courses/50091);
  * [ТП](https://hwproj.ru/courses/50092).
* бонуса для особо отличившихся — $B \in \\{0, 1\\}$ — эквивалент «+1 весёлая буква ECTS».

Кто не сдаёт теоретическую часть зачёта/экзамена устно, те получают не более E (ECTS), см. ниже.
