...
Чтобы ГЭК убедилась в том, что ваша работа включает достойный практический
результат, следует показать или программный код, или акт о внедрении результата
...
- Акт о внедрении говорит, что результат был (или вероятно скоро будет) внедрён
  ...
  форме, [пример акта доступен по ссылке](/docs/templates/implementation-act-template.docx).
