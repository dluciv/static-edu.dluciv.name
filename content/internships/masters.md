...
## Дисциплина в семестре

{% <alert important={true}> %}

Если у вас научный руководитель — Д. В. Луцив, то вот важная информация.
Поскольку студентов к счастью много на всех курсах, а преподавателей увы мало, за всеми уследить тяжело. И требуется малыми усилиями удерживать ситуацию под контролем.
Сейчас малые усилия заключаются в том, что **не реже, чем раз в две недели** студенты должны заполнить [эту формочку](https://forms.yandex.ru/u/6aa6526402848f9bba703ef6).
Со второго раза должно быть легче, браузер половину заполнит сам.

Имейте в виду:

1. Даже если не притрагивались две недели к работе, всё равно заполняйте. Так честно и пишите, что ничего не сделано, потому-то. Иначе возможно снижение рекомендуемой оценки.
2. Эта формочка — способ не оперативной связи, а журналирования работы. Если нужна оперативная связь, пользуйтесь другими средствами.
